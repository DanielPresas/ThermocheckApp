...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --disable-programs --disable-d3d11va --disable-dxva2 --arch=x86_64 --enable-shared --enable-cross-compile --target-os=win32 --extra-cflags='-MD -DWINAPI_FAMILY=WINAPI_FAMILY_APP -D_WIN32_WINNT=0x0A00' --extra-ldflags='-APPCONTAINER WindowsApp.lib' --prefix=../../../Build/Windows10/x64
...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.26.28806 for x64
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=cl.exe
...
AS=cl.exe
OBJCC=cl.exe
LD=/c/ffmpeg/compat/windows/mslink
DEPCC=cl.exe
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -DPIC -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo -MD -DWINAPI_FAMILY=WINAPI_FAMILY_APP -D_WIN32_WINNT=0x0A00   -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -utf-8
CXXFLAGS=  -D__STDC_CONSTANT_MACROS 
OBJCFLAGS= -nologo 
ASFLAGS= -nologo -MD -DWINAPI_FAMILY=WINAPI_FAMILY_APP -D_WIN32_WINNT=0x0A00 -Z7
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -m64 -S -nocudalib -nocudainc --cuda-device-only -include /c/ffmpeg/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=cl.exe
DOXYGEN=doxygen
LDFLAGS= -APPCONTAINER WindowsApp.lib -nologo     -debug
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-swscale=
EXTRALIBS-postproc=
EXTRALIBS-avformat=ws2_32.lib
EXTRALIBS-avcodec=mfplat.lib mfuuid.lib ole32.lib strmiids.lib ole32.lib
EXTRALIBS-swresample=
EXTRALIBS-avresample=
EXTRALIBS-avutil=dxgi.lib d3d11.lib bcrypt.lib
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=ole32.lib psapi.lib
EXTRALIBS-cpu_init=
EXTRALIBS-cws2fws=
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
