...
=item B<hls_master_name> I<file_name>B<>
...
=item B<global_sidx> I<global_sidx>B<>
...
=item B<ldash> I<ldash>B<>

Enable Low-latency Dash by constraining the presence and values of some elements.


=item B<master_m3u8_publish_rate> I<master_m3u8_publish_rate>B<>

Publish master playlist repeatedly every after specified number of segment intervals.


=item B<write_prft> I<write_prft>B<>
...
=item B<min_playback_rate> I<min_playback_rate>B<>
...
=item B<max_playback_rate> I<max_playback_rate>B<>
...
=item B<protocol_opts> I<options_list>B<>
