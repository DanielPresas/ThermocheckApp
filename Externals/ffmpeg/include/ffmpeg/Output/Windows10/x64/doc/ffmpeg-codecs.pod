...
=item B<-aribb24-base-path> I<path>B<>
...
=item B<-aribb24-skip-ruby-text> I<boolean>B<>
...
=item B<enable-rect-partitions (>I<boolean>B<)>

Enable rectangular partitions. Default is true.


=item B<enable-1to4-partitions (>I<boolean>B<)>

Enable 1:4/4:1 partitions. Default is true.


=item B<enable-ab-partitions (>I<boolean>B<)>

Enable AB shape partitions. Default is true.


=item B<enable-angle-delta (>I<boolean>B<)>

Enable angle delta intra prediction. Default is true.


=item B<enable-cfl-intra (>I<boolean>B<)>

Enable chroma predicted from luma intra prediction. Default is true.


=item B<enable-filter-intra (>I<boolean>B<)>

Enable filter intra predictor. Default is true.


=item B<enable-intra-edge-filter (>I<boolean>B<)>

Enable intra edge filter. Default is true.


=item B<enable-smooth-intra (>I<boolean>B<)>

Enable smooth intra prediction mode. Default is true.


=item B<enable-paeth-intra (>I<boolean>B<)>

Enable paeth predictor in intra prediction. Default is true.


=item B<enable-palette (>I<boolean>B<)>
