...
=item B<connect_timeout=>I<milliseconds>B<>
...
=item B<latency=>I<microseconds>B<>
...
=item B<enforced_encryption=>I<1|0>B<>
...
=item B<kmrefreshrate=>I<packets>B<>
...
=item B<kmpreannounce=>I<packets>B<>
...
=item B<peerlatency=>I<microseconds>B<>
...
=item B<rcvlatency=>I<microseconds>B<>
