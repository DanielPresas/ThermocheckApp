...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --disable-programs --disable-d3d11va --disable-dxva2 --arch=x86_64 --enable-shared --enable-cross-compile --target-os=win32 --extra-cflags='-MD -DWINAPI_FAMILY=WINAPI_FAMILY_APP -D_WIN32_WINNT=0x0A00' --extra-ldflags='-APPCONTAINER WindowsApp.lib' --prefix=../../../Build/Windows10/x64"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "../../../Build/Windows10/x64/share/ffmpeg"
#define AVCONV_DATADIR "../../../Build/Windows10/x64/share/ffmpeg"
